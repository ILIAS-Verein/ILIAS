...
*
* @ilCtrl_isCalledBy ilObjExampleGUI: ilRepositoryGUI, ilAdministrationGUI, ilObjPluginDispatchGUI
* @ilCtrl_Calls ilObjExampleGUI: ilPermissionGUI, ilInfoScreenGUI, ilObjectCopyGUI, ilCommonActionDispatcherGUI
* @ilCtrl_Calls ilObjExampleGUI: ilExportGUI
*
*/
class ilObjExampleGUI extends ilObjectPluginGUI
{
	/**
	* Initialisation
	*/
